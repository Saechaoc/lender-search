...
This project is indexed by GitNexus as **lender-search** (134 symbols, 154 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
